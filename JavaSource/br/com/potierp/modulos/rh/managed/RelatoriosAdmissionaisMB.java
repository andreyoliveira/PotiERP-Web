 ...
 *
 */
public class RelatoriosAdmissionaisMB extends BaseMB{
	
	private static Logger log = Logger.getLogger(RelatoriosAdmissionaisMB.class);
	...
	public String doRelatoriosAdmissionais() {
		return NavigationEnum.RELATORIOS_ADMISSIONAIS.getValor();
	}
	
	public boolean isConsultarRelatoriosAdmissionais(){
		return isConsultar();
	}
